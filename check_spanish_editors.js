...
const spanishEditors = editors.filter(d => (d.region === "spanish" || d.region === "spanish-portuguese" || d.region === "spanish-and-portuguese" || d.region.includes("spanish")));

let missing = false;
spanishEditors.forEach(d => {
    console.log(`\n=== ${d.name} ===`);
    if (d.mustWatch) {
