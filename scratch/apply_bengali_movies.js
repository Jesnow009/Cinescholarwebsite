...
const txtPath = path.join(__dirname, 'bengali_movies.txt');
...
const knownDirectors = [
    "Satyajit Ray", "Ritwik Ghatak", "Mrinal Sen", "Aparna Sen", 
    "Rituparno Ghosh", "Buddhadeb Dasgupta", "Kaushik Ganguly", "Srijit Mukherji"
];
...
console.log(`Successfully updated ${updatedCount} Bengali directors.`);
...
fs.writeFileSync(path.join(__dirname, 'bengali_movie_titles.json'), JSON.stringify(titles, null, 2));
